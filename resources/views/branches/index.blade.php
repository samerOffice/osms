                        ...
                        <tr>
                         ...
                         @if( (auth()->user()->role_id == 1) || (auth()->user()->role_id == 2))
                          <td>
                            ...
                            <button class="btn btn-outline-danger" onclick="deleteOperation({{$branch->id}})"><i class="fa-solid fa-trash"></i> Delete</button>
                          </td>
                          @endif
                        </tr> 
                        @endforeach              
...
function deleteOperation(row_id)
    { 
      ...
      if (result.isConfirmed) {
            ...
            axios.post('/api/delete_branch/'+ row_id).then(response=>{
