...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-outline-info float-right" href="{{route('daily_expense_list')}}">
            ...
            <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-body">
                        <form id="updateDailyExpenseForm">
                            <div class="card-body">
...
$('.select2bs4').select2({
    ...
    document.getElementById('updateDailyExpenseForm').addEventListener('submit',function(event){
    event.preventDefault();


    var updateDailyExpenseFormData = new FormData(this);
    ...
    axios.post('/api/update_daily_expense/' + expense_id, updateDailyExpenseFormData).then(response=>{
    console.log(response);
    setTimeout(function() {
        window.location.href = "{{ route('daily_expense_list') }}";
        }, 2000);
    Swal.fire({
                icon: "success",
