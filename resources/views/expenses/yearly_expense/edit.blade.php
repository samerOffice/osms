            ...
            <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-body">
                        <form id="updateYearlyExpenseForm">
                            <div class="card-body">
...
$('.select2bs4').select2({
    ...
    document.getElementById('updateYearlyExpenseForm').addEventListener('submit',function(event){
    event.preventDefault();


    var updateYearlyExpenseFormData = new FormData(this);
    ...
    axios.post('/api/update_yearly_expense/' + expense_id, updateYearlyExpenseFormData).then(response=>{
