            ...
            <div class="report-info">
                ...
                <table style="font-family: 'Courier New', Courier, monospace; font-size: 18px;">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="6" style="text-align:right">Total Sales (BDT)</td>
                            <td></td>
                            <td>{{ number_format($totalSales, 2) }}</td>
                        </tr>
                        <tr>
                            <td colspan="6" style="text-align:right">Total Profit (BDT)</td>
                            <td >{{ number_format($totalProfit, 2) }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="6" style="text-align:right">Total Due (BDT)</td>
                            <td>{{ number_format($total_due, 2) }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="6" style="text-align:right">Net Profit (BDT)</td>
