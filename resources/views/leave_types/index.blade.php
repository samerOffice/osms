    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <a class="btn btn-outline-info float-right" href="{{route('add_leave_type')}}">
                    ...
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          @if( (auth()->user()->role_id == 1) || (auth()->user()->role_id == 2))
                          <td>
                            <a href="{{route('edit_leave_type',$leave_type->id)}}" style="color: white"><button class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i> Edit</button></a>
                            <button class="btn btn-outline-danger" onclick="deleteOperation({{$leave_type->id}})"><i class="fa-solid fa-trash"></i> Delete</button>
                          </td>
                          @endif
                        </tr> 
                        @endforeach              
