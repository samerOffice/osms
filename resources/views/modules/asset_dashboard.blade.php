              ...
              <div class="app-page-title">
                <div class="page-title-wrapper">
                  <div class="page-title-heading">
                    ...
                    <div>Asset Management Dashboard
                      <div class="page-title-subheading">An Asset Management System simplifies organizational operations by automating asset tracking, maintenance schedules, and lifecycle management.
                      </div>
                    </div>
                  </div>      
                </div>
