                        ...
                        <form id="itemCategoryForm" >                                        
                            <div class="card-body">
                              <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="item_category_name" name="item_category_name" >
                              </div> 
...
document.getElementById('itemCategoryForm').addEventListener('submit',function(event){
  event.preventDefault();

var itemCategoryFormData = new FormData(this);
...
axios.get('sanctum/csrf-cookie').then(response=>{
 axios.post('/osms/api/submit_item_category',itemCategoryFormData).then(response=>{
  console.log(response);
  setTimeout(function() {
    window.location.href = "{{ route('item_category_list') }}";
      }, 2000);
  Swal.fire({
              icon: "success",
