                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="btn btn-outline-danger" onclick="deleteOperation({{$product_category->id}})"><i class="fa-solid fa-trash"></i> Delete</button>
                          </td>
                          {{-- @endif --}}
                        </tr> 
                        @endforeach              
...
function deleteOperation(row_id)
    { 
      ...
      if (result.isConfirmed) {
            ...
            axios.post('/api/delete_product_category/'+ row_id).then(response=>{
