                    ...
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{route('edit_customer',$customer->id)}}" style="color: white"><button class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i> Edit</button></a>
                            <button class="btn btn-outline-danger" onclick="deleteOperation({{$customer->id}})"><i class="fa-solid fa-trash"></i> Delete</button>
                          </td>
