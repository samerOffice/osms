...
class CreatePosTables extends Migration
{
    ...
    public function up()
    {
        Schema::connection($this->connection)->create('inventory_log', function (Blueprint $table) {
            $table->id();
        ...
        Schema::connection($this->connection)->create('item_categories', function (Blueprint $table) {
            $table->id();
        ...
        Schema::connection($this->connection)->create('product_batch', function (Blueprint $table) {
            $table->id();
        ...
        Schema::connection($this->connection)->create('product_categories', function (Blueprint $table) {
            $table->id();
            $table->integer('company_id')->nullable();
        ...
        Schema::connection($this->connection)->create('product_requisitions', function (Blueprint $table) {
            $table->id();
        ...
        Schema::connection($this->connection)->create('product_sales', function (Blueprint $table) {
            $table->id();
            $table->integer('product_id')->nullable();
            $table->string('product_tag_number', 100)->nullable();
            $table->string('batch_number', 100)->nullable();
        ...
        Schema::connection($this->connection)->create('product_status', function (Blueprint $table) {
            $table->id();
            $table->string('status_name', 500)->nullable();
            $table->timestamps();
        });

        Schema::connection($this->connection)->create('requisition_orders', function (Blueprint $table) {
            $table->id();
            $table->integer('company_id')->nullable();
        ...
        Schema::connection($this->connection)->create('warehouses', function (Blueprint $table) {
            $table->id();
            $table->integer('company_id')->nullable();
            $table->integer('branch_id')->nullable();
    ...
    {
        Schema::connection($this->connection)->dropIfExists('inventory_log');
        Schema::connection($this->connection)->dropIfExists('item_categories');
        Schema::connection($this->connection)->dropIfExists('products');
        Schema::connection($this->connection)->dropIfExists('product_batch');
        Schema::connection($this->connection)->dropIfExists('product_categories');
        Schema::connection($this->connection)->dropIfExists('product_requisitions');
        Schema::connection($this->connection)->dropIfExists('product_sales');
        Schema::connection($this->connection)->dropIfExists('product_status');
        Schema::connection($this->connection)->dropIfExists('requisition_orders');
